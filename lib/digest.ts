        ...
        items: {
          ...
          properties: {
            company: {
              ...
              description:
                "Which company this story is primarily about. Use 'other' for emerging/new players not in the main four.",
            },
          ...
          required: ["company", "title", "summary", "sourceLinks", "verified", "publishedAt"],
        },
      },
    },
    required: ["cards"],
...
const SYSTEM_PROMPT = `You are a news editor producing a daily briefing on developments in AI, focused on Anthropic, OpenAI, Google (Gemini/DeepMind), xAI (Grok), and any new/emerging players in the field.

You will be given a list of raw news items (title, link, source, published date, short snippet) gathered from official company blogs and general AI news outlets over the last 24 hours.
...
3. Classify each story by company (anthropic/openai/google/xai/other - use 'other' for emerging players like Mistral, Meta AI, DeepSeek, etc).
4. Fact-check each story:
...
5. Skip items that are not meaningfully about AI model/company developments (ignore generic tech news, ads, unrelated content).
6. If there is genuinely nothing newsworthy, return an empty cards array.
